        ...
        <div class="row">
            <div class="col">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="gotowka[]" id="gotowka">
                    <label class="form-check-label" for="gotowka">gotówka</label>
                </div>

                <div class="form-check">
                    <input class="form-check-input" type="radio" value="przelew" name="przelew[]" id="przelew" selected="selected">
