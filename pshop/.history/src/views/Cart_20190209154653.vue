    ...
    <div class="col-3">
        ...
        <div class="row">
            <div class="col text-left">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="platnosc" value="gotowka">
        ...
        <div class="row">
            <div class="col text-left mt-5">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="wlasny" name="transport">
                    <label class="form-check-label" for="gotowka">Odbiór własny w siedzibie firmy (+0 zł)</label>
                </div>

                <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="warszawa" id="transport">
                    <label class="form-check-label" for="gotowka">Wysyłka na terenie Warszawy transportem własnym (+25 zł)</label>
                </div>

                <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="kurier" id="transport">
